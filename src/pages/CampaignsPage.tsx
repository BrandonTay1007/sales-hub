...
import { campaigns as initialCampaigns, users, Campaign } from '@/lib/mockData';
                ...
                {campaigns.map((campaign) => {
                  ...
                  return (
                    <tr key={campaign.id} className="table-row">
                      ...
                      <td className="table-cell">
                        <span className={`badge ${campaign.type === 'live' ? 'bg-destructive/10 text-destructive' : 'bg-primary/10 text-primary'}`}>
                          {campaign.type}
                        </span>
                      </td>
                      <td className="table-cell">{salesPerson?.name || '-'}</td>
                      <td className="table-cell">
