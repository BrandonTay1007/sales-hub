...
A startup company has been selling their products in social media (such as Facebook, Instagram) and they have been recording their sales manually with Excel and papers. The nature of their business depends on sales person selling their products in campaign basis (such as Facebook Post, Facebook Live Video, Instagram Stories) and ever since their business growth, this manual work has created tremendous amount of problems in recording the accurate sales and paying out their sales person.

## Request from the client

So right now, the owner has engaged us to build a custom software to track their sales person performance based on campaign and sales orders and will need to correctly record the payout for each of them. The below are the requirements we have captured so far based on her problems.
